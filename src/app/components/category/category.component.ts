...
export class CategoryComponent implements OnInit {
  ...
  // Explicit
  private imageCategoryStrings: string[];
  private titleCategoryStrings: string[];
  private detailCategoryStrings: string[];

  constructor() { }

  ngOnInit() {

    this.imageCategoryStrings = [
      "assets/MyImages/01-00002-01.png",
      "assets/MyImages/02-00554-04.png",
      "assets/MyImages/02-00174-01.png",
      "assets/MyImages/02-00540-01.png"
    ]

    this.titleCategoryStrings = [
      "Lorem Ipsum คืออะไร?",
      "ทำไมจึงต้องนำมาใช้?",
      "มันมีที่มาอย่างไร?",
